...
$hide_top_bar = ecoshop_option('hide_top_bar');
if($hide_top_bar != 1){ ?>
    <div class="top-bar">
        <div class="container">
            <div class="curency sw">
                <?php $top_bar_email = ecoshop_option('top_bar_email');
                if(!empty($top_bar_email)){ ?>
                    <p><a href="mailto:<?php echo esc_attr($top_bar_email); ?>"><?php esc_attr_e('E:','ecoshop'); ?> <?php echo esc_attr($top_bar_email); ?></a> </p>
                <?php } ?>
            </div>
            <!-- Login Info -->
                ...
                <ul>
                    <?php if($hide_account_icon != 1){ ?>
                        ...
                        <?php if(!empty($myaccount_page_url)){ ?>
                            <li><a href="<?php echo esc_url($myaccount_page_url); ?>"> <?php esc_attr_e('MY ACCOUNT','ecoshop'); ?> </a></li>
                        <?php }
                        if(!empty($cart_url)){ ?>
                        ...
                        <li class="dropdown user-basket">
                            ...
                            <ul class="dropdown-menu img-adjustment append-here">
