        ...
        <div class="container">
            ...
            <div class="logo">
                <a href="<?php echo esc_url(home_url('/')); ?>">
                    <?php $transparent_header_logo = ecoshop_option('transparent_header_logo');
                    if(!empty($transparent_header_logo)){ ?>
                        <img class="img-responsive" src="<?php echo esc_url($transparent_header_logo); ?>" alt="" >
                    <?php } else{ ?>
                        <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/logo-1.png" alt="" >
                    <?php } ?>
                </a>
            </div>
            <nav class="navbar ownmenu">
                ...
                <!-- Nav Right -->
                <div class="nav-right">
                    <ul class="navbar-right adjustment">
                        ...
                        <?php } if($hide_cart_icon != 1){ ?>
                            ...
                            <li class="dropdown user-basket">
                                ...
                                <ul class="dropdown-menu cart-adjustment append-here">
