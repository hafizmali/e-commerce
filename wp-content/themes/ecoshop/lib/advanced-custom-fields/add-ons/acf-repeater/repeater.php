...
class acf_field_repeater extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'repeater';
		$this->label = __("Repeater",'ecoshop');
		$this->category = __("Layout",'ecoshop');
	...
	*/
	...
	function create_field( $field )
	{
		...
		$defaults = array(
			...
			'layout' 		=> 'table',
			'sub_fields'	=>	array(),
			'button_label'	=>	__("Add Row",'ecoshop'),
			'value'			=>	array(),
		);
	...
	*/
	...
	function create_options( $field )
	{
		...
		$field['sub_fields'][] = apply_filters('acf/load_field_defaults',  array(
			'key' => 'field_clone',
			'label' => __("New Field",'ecoshop'),
			'name' => __("new_field",'ecoshop'),
			'type' => 'text',
		));
...
<tr class="field_option field_option_<?php echo ''.$this->name; ?> field_option_<?php echo ''.$this->name; ?>_fields">
	<td class="label">
		<label><?php _e("Repeater Fields",'ecoshop'); ?></label>
	</td>
	<td>
	<div class="repeater">
		<div class="fields_header">
			<table class="acf widefat">
				<thead>
					<tr>
						<th class="field_order"><?php _e('Field Order','ecoshop'); ?></th>
						<th class="field_label"><?php _e('Field Label','ecoshop'); ?></th>
						<th class="field_name"><?php _e('Field Name','ecoshop'); ?></th>
						<th class="field_type"><?php _e('Field Type','ecoshop'); ?></th>
					</tr>
				</thead>
			</table>
		</div>
		<div class="fields">
			<div class="no_fields_message" <?php if(count($field['sub_fields']) > 1){ echo 'style="display:none;"'; } ?>>
				<?php _e("No fields. Click the \"+ Add Sub Field button\" to create your first field.",'ecoshop'); ?>
			</div>
					...
					<table class="acf widefat">
						<tr>
							...
							<td class="field_label">
								<strong>
									<a class="acf_edit_field" title="<?php _e("Edit this Field",'ecoshop'); ?>" href="javascript:;"><?php echo ''.$sub_field['label']; ?></a>
								</strong>
								<div class="row_options">
									<span><a class="acf_edit_field" title="<?php _e("Edit this Field",'ecoshop'); ?>" href="javascript:;"><?php _e("Edit",'ecoshop'); ?></a> | </span>
									<span><a title="<?php _e("Read documentation for this field",'ecoshop'); ?>" href="http://www.advancedcustomfields.com/docs/field-types/" target="_blank"><?php _e("Docs",'ecoshop'); ?></a> | </span>
									<span><a class="acf_duplicate_field" title="<?php _e("Duplicate this Field",'ecoshop'); ?>" href="javascript:;"><?php _e("Duplicate",'ecoshop'); ?></a> | </span>
									<span><a class="acf_delete_field" title="<?php _e("Delete this Field",'ecoshop'); ?>" href="javascript:;"><?php _e("Delete",'ecoshop'); ?></a>
								</div>
							</td>
						...
						<table class="acf_input widefat">
							<tbody>
								<tr class="field_label">
									<td class="label">
										<label><span class="required">*</span><?php _e("Field Label",'ecoshop'); ?></label>
										<p class="description"><?php _e("This is the name which will appear on the EDIT page",'ecoshop'); ?></p>
									</td>
									<td>
										<?php 
								...
								<tr class="field_name">
									<td class="label">
										<label><span class="required">*</span><?php _e("Field Name",'ecoshop'); ?></label>
										<p class="description"><?php _e("Single word, no spaces. Underscores and dashes allowed",'ecoshop'); ?></p>
									</td>
									<td>
										<?php 
										do_action('acf/create_field', array(
								...
								<tr class="field_type">
									<td class="label"><label><span class="required">*</span><?php _e("Field Type",'ecoshop'); ?></label></td>
									<td>
										<?php 
										do_action('acf/create_field', array(
											'type'	=>	'select',
								...
								<tr class="field_instructions">
									<td class="label"><label><?php _e("Field Instructions",'ecoshop'); ?></label></td>
									<td>
										<?php
								...
								<tr class="field_column_width">
									<td class="label">
										<label><?php _e("Column Width",'ecoshop'); ?></label>
										<p class="description"><?php _e("Leave blank for auto",'ecoshop'); ?></p>
									</td>
									<td>
										<?php 
								...
								<tr class="field_save">
									<td class="label">
										<!-- <label><?php _e("Save Field",'ecoshop'); ?></label> -->
									</td>
									<td>
										<ul class="hl clearfix">
											<li>
												<a class="acf_edit_field acf-button grey" title="<?php _e("Close Field",'ecoshop'); ?>" href="javascript:;"><?php _e("Close Sub Field",'ecoshop'); ?></a>
											</li>
										</ul>
									</td>
								</tr>								
		...
		<div class="table_footer">
			<div class="order_message"><?php _e('Drag and drop to reorder','ecoshop'); ?></div>
			<a href="javascript:;" id="add_field" class="acf-button"><?php _e('+ Add Sub Field','ecoshop'); ?></a>
		</div>
	</div>
	</td>
</tr>
<tr class="field_option field_option_<?php echo ''.$this->name; ?>">
	<td class="label">
		<label><?php _e("Minimum Rows",'ecoshop'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
...
<tr class="field_option field_option_<?php echo ''.$this->name; ?>">
	<td class="label">
		<label><?php _e("Maximum Rows",'ecoshop'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
...
<tr class="field_option field_option_<?php echo ''.$this->name; ?> field_option_<?php echo ''.$this->name; ?>_layout">
	<td class="label">
		<label><?php _e("Layout",'ecoshop'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'table'	=>	__("Table (default)",'ecoshop'),
				'row'	=>	__("Row",'ecoshop')
			)
		));
		?>
...
<tr class="field_option field_option_<?php echo ''.$this->name; ?>">
	<td class="label">
		<label><?php _e("Button Label",'ecoshop'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
