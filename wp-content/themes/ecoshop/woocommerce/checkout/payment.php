...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button alt btn  btn-dark pull-right margin-top-30" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' ); ?>
